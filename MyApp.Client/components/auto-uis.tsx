            ...
            >
                ...
                >
                    <div className="text-3xl font-mono">
                        <span className="text-blue-600 hover:text-blue-700 font-semibold">{slides[currentIndex].path}</span>
                    </div>
                </a>
...
const AutoUis: FC<{ className?: string }> = ({ className }) => {
    ...
    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[400px] opacity-30 pointer-events-none">
      <div className="absolute inset-0 bg-gradient-to-r from-blue-100 via-purple-100 to-blue-100 dark:from-blue-900/40 dark:via-purple-900/40 dark:to-blue-900/40 blur-3xl rounded-full" />
    </div>

    <div className="relative z-10 container mx-auto px-4 text-center">

      {/* Main Title with Gradient */}
      <h1 className="max-w-4xl mx-auto mb-6 text-6xl md:text-7xl lg:text-8xl font-extrabold tracking-tight text-slate-900 dark:text-white">
        Built-in <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400">UIs</span>
      </h1>
